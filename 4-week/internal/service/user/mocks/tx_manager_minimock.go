...
//go:generate minimock -i github.com/DaniilKalts/microservices-course-2023/4-week/internal/clients/database.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_database "github.com/DaniilKalts/microservices-course-2023/4-week/internal/clients/database"
	"github.com/gojuno/minimock/v3"
)

// TxManagerMock implements mm_database.TxManager
...
// NewTxManagerMock returns a mock for mm_database.TxManager
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, f mm_database.Handler) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) ExpectFParam2(f mm_database.Handler) *mTxManagerMockReadCommitted {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, f mm_database.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, f mm_database.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, f mm_database.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
// ReadCommitted implements mm_database.TxManager
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, f mm_database.Handler) (err error) {
