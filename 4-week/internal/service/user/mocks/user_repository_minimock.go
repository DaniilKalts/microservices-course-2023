...
//go:generate minimock -i github.com/DaniilKalts/microservices-course-2023/4-week/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, user *models.User, passwordHash string) (s1 string, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, user *models.User, passwordHash string)
	...
	funcGet          func(ctx context.Context, id string) (up1 *models.User, err error)
	...
	funcUpdate          func(ctx context.Context, id string, userPatch *models.UpdateUserPatch) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id string, userPatch *models.UpdateUserPatch)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, user *models.User, passwordHash string) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) ExpectUserParam2(user *models.User) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, user *models.User, passwordHash string)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, user *models.User, passwordHash string) (s1 string, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, user *models.User, passwordHash string) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, user *models.User, passwordHash string) (s1 string, err error) {
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id string) (up1 *models.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id string) (up1 *models.User, err error) {
...
type UserRepositoryMockUpdateParams struct {
	ctx       context.Context
	id        string
	userPatch *models.UpdateUserPatch
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id string, userPatch *models.UpdateUserPatch) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, id, userPatch}
...
// ExpectUserPatchParam3 sets up expected param userPatch for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUserPatchParam3(userPatch *models.UpdateUserPatch) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.userPatch = &userPatch
	mmUpdate.defaultExpectation.expectationOrigins.originUserPatch = minimock.CallerInfo(1)

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id string, userPatch *models.UpdateUserPatch)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id string, userPatch *models.UpdateUserPatch) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id string, userPatch *models.UpdateUserPatch) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserRepositoryMockUpdateParams{ctx, id, userPatch},
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id string, userPatch *models.UpdateUserPatch) (err error) {
	...
	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, id, userPatch)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, id, userPatch}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, id, userPatch}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userPatch != nil && !minimock.Equal(*mm_want_ptrs.userPatch, mm_got.userPatch) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter userPatch, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmUpdate.UpdateMock.defaultExpectation.expectationOrigins.originUserPatch, *mm_want_ptrs.userPatch, mm_got.userPatch, minimock.Diff(*mm_want_ptrs.userPatch, mm_got.userPatch))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, id, userPatch)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, id, userPatch)
	return
}
