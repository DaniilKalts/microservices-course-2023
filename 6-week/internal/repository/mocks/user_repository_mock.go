...
//go:generate minimock -i github.com/DaniilKalts/microservices-course-2023/6-week/internal/repository/user.Repository -o user_repository_mock.go -n UserRepositoryMock -p mocks
