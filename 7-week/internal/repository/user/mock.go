...
//go:generate minimock -i github.com/DaniilKalts/microservices-course-2023/7-week/internal/repository/user.Repository -o mock.go -n UserRepositoryMock -p user
...
// NewUserRepositoryMock returns a mock for Repository
...
// GetCredentialsByEmail implements Repository
